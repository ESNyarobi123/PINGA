                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="md:col-span-2 rounded-lg border border-amber-200 dark:border-amber-900/50 bg-amber-50/50 dark:bg-amber-950/20 p-4 space-y-4">
                                        <h4 class="text-sm font-semibold text-zinc-900 dark:text-white">{{ __('messages.admin_settings.suspension_appeal_section') }}</h4>
                                        <p class="text-xs text-zinc-600 dark:text-zinc-400">{{ __('messages.admin_settings.suspension_appeal_hint') }}</p>
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div>
                                                <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">{{ __('messages.admin_settings.suspension_appeal_email') }}</label>
                                                <input wire:model.live="settings.suspension_appeal_email"
                                                       type="email"
                                                       placeholder="{{ __('messages.admin_settings.support_email') }}"
                                                       class="w-full px-3 py-2 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg text-sm">
                                                @error('settings.suspension_appeal_email')
                                                <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-1">{{ __('messages.admin_settings.suspension_appeal_whatsapp') }}</label>
                                                <input wire:model.live="settings.suspension_appeal_whatsapp"
                                                       type="tel"
                                                       placeholder="+2557XXXXXXXX"
                                                       class="w-full px-3 py-2 bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg text-sm">
                                                @error('settings.suspension_appeal_whatsapp')
                                                <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                                @enderror
                                            </div>
                                        </div>
