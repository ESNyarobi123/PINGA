            ...
            <div class="p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex gap-3 pt-4">
                        <button wire:click="$set('depositStep', 1)" wire:loading.attr="disabled" wire:target="processPayment" class="flex-1 px-4 py-3 bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 font-medium rounded-lg hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors disabled:opacity-50">
                            {{ __('messages.wallet.back') }}
                        </button>
                        <button wire:click="processPayment" wire:loading.attr="disabled" wire:target="processPayment" class="flex-1 px-4 py-3 bg-emerald-600 text-white font-medium rounded-lg hover:bg-emerald-700 transition-colors disabled:opacity-70 flex items-center justify-center gap-2">
                            <svg wire:loading wire:target="processPayment" class="w-5 h-5 animate-spin" fill="none" viewBox="0 0 24 24">
                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
                                <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"/>
                            </svg>
                            <span wire:loading.remove wire:target="processPayment">{{ __('messages.wallet.continue') }}</span>
                            <span wire:loading wire:target="processPayment">Inatuma...</span>
                        </button>
                    </div>
                </div>
