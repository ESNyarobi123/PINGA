                ...
                >
                    <div class="flex-shrink-0 w-10 h-10 rounded-xl flex items-center justify-center shadow-sm {{ $colorClass }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            ...
                            @elseif($notif['icon'] === 'megaphone')
                                <path stroke-linecap="round" stroke-linejoin="round" d="M10.34 3.94c.09-.542.56-.94 1.11-.94h2.093c.477 0 .866.384.866.86 0 .552-.448.998-1.001 1.005v5.59c0 .654-.539 1.183-1.204 1.183h-.618a.75.75 0 01-.75-.75v-1.906a4.73 4.73 0 01-1.086-.45L8.75 12.5v1.25c0 .414-.336.75-.75.75H6.25a.75.75 0 01-.75-.75v-4.5a.75.75 0 01.75-.75h1.75a.75.75 0 01.75.75v1.25l2.16-1.281A4.73 4.73 0 0110.5 9.25V4.06c0-.043 0-.087-.01-.13zM15.75 9.5c.206 0 .403.043.586.122l-.01-.01a3 3 0 012.914 3.574v3.566a3 3 0 01-2.914 3.574l-.01-.01c-.183.079-.38.122-.586.122V9.5z"/>
                            @elseif($notif['icon'] === 'wrench')
                                <path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75a4.5 4.5 0 01-4.884 4.884c-1.076-.091-2.264.071-2.976.783a1.125 1.125 0 01-1.591 0l-.106-.106a1.125 1.125 0 010-1.591l.106-.106c.712-.712.874-1.9.783-2.976a4.5 4.5 0 016.688-4.884L21.75 6.75zm-9.261 7.261a.75.75 0 11-1.06-1.06l-3.75 3.75a.75.75 0 001.06 1.06l3.75-3.75z"/>
                            @elseif($notif['icon'] === 'exclamation-triangle')
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z"/>
                            @elseif($notif['icon'] === 'information-circle')
